...
class Kalendar
{
    ...
    /**
     * @var DateTimeUtilities Objekt aktualného času
     */
    ...
    /**
     * @var DateTimeUtilities Objekt Vybratého času
     */
    ...
    public function __construct($vybratyRok, $vybratyMesiac, $vybratyDen)
    {
        ...
        $this->vybratyDatum = new DateTimeUtilities($vybratyRok . '-' . $vybratyMesiac . '-' . $vybratyDen);
        ...
        $this->vybratyDatumModyfikacie = new DateTimeUtilities($vybratyRok . '-' . $vybratyMesiac . '-' . $vybratyDen);

        $this->poslednyDenMesiac = DateTimeUtilities::lastDayOfMonth($this->vybratyDatumModyfikacie)->format('j');
    }
    ...
    {
        $prvyDenMesiaca = DateTimeUtilities::prvyDenMesiaca($this->vybratyDatumModyfikacie)->format('w');
        ...
        $poslednyDenMesiaca = DateTimeUtilities::lastDayOfMonth($this->vybratyDatumModyfikacie)->format('w');
