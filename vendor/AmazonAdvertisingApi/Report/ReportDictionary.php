...
class ReportDictionary
{
    ...
    const DICTIONARY = [
        ...
        SelectDateTable::SELECT_START_DATE => ['title' => 'Start', 'description' => 'Selected report date from'],
        SelectDateTable::SELECT_END_DATE => ['title' => 'End', 'description' => 'Selected report date to'],
        ...
        'acos_clicks14d' => ['title' => 'ACOS', 'description' => 'Advertising cost of sales based on purchases made within 14 days of an ad click.'],
        ...
        'ad_keyword_status' => ['title' => 'Status', 'description' => 'Current status of a keyword.'],
        ...
        'click_through_rate' => ['title' => 'CTR', 'description' => 'Clicks divided by impressions.'],
        'cost' => ['title' => 'Spend', 'description' => 'Total cost of ad clicks. Same as spend.'],
        'cost_per_click' => ['title' => 'CPC', 'description' => 'Total cost divided by total number of clicks.'],
        ...
        'impressions' => ['title' => 'Impress', 'description' => 'Total number of ad impressions.'],
        ...
        'match_type' => ['title' => 'Match', 'description' => 'Type of matching for the keyword used in bid. For keywords, one of: BROAD, PHRASE, or EXACT. For targeting expressions, one of TARGETING_EXPRESSION or TARGETING_EXPRESSION_PREDEFINED. Same as keywordType.'],
        ...
        'purchases7d' => ['title' => 'Orders', 'description' => 'Number of attributed conversion events occurring within 7 days of an ad click.'],
        ...
        'roas_clicks14d' => ['title' => 'ROAS', 'description' => 'Return on ad spend based on purchases made within 14 days of an ad click.'],
        ...
        'sales7d' => ['title' => 'Sales', 'description' => 'Total value of sales occurring within 7 days of an ad click.'],
