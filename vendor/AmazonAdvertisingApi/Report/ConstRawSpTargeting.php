...
/**
 * Trieda na prípravu údajov pre spTargeting
 */
class ConstRawSpTargeting
{
    const REPORT_TYPE_ID = 'spTargeting';
    const GRPUP_BY = ['targeting'];
    ...
    const BASE_METRICS = ['impressions', 'clicks', 'costPerClick', 'clickThroughRate', 'cost', 'purchases1d', 'purchases7d',
                ...
                'portfolioId', 'campaignName', 'campaignId', 'campaignBudgetType', 'campaignBudgetAmount', 'campaignStatus',
